...
import { addCartItem } from '@/services/storage'
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            >
              <div className="flex-1">
                ...
                {product.description && (
                  <p className="text-neutral-600 mb-10 leading-relaxed">{product.description}</p>
                )}

                <div className="mb-8">
                  <h3 className="text-xs tracking-widest text-neutral-500 uppercase mb-4">Tamanho</h3>
                ...
                <div className="mb-10">
                  <h3 className="text-xs tracking-widest text-neutral-500 uppercase mb-4">Quantidade</h3>
