              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label>Logo</Label>
                    {formData.logo_url && (
                      <img src={formData.logo_url} alt="Logo" className="h-16 object-contain mb-2" />
                    )}
                    <input
                      type="file"
                      accept="image/*"
                  ...
                  <div className="space-y-2">
                    ...
                    {formData.hero_image_url && (
                      <img src={formData.hero_image_url} alt="Banner" className="h-24 object-cover w-full rounded mb-2" />
                    )}
                    <input
                      type="file"
                      accept="image/*"
                ...
                {products.map(p => (
                  <div key={p.id} className="flex gap-4 border border-neutral-100 p-4 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {p.stock !== undefined && (
                        <p className="text-xs text-neutral-400">Estoque: {p.stock}</p>
                      )}
                    </div>
